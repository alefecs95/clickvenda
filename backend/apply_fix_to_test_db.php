...
try {
    ...
    echo "Aplicando correção no banco de teste...\n";
    echo "======================================\n\n";
    ...
    try {
        ...
        $correctOrder = [
            ...
            // Batch 6 - Tabelas que dependem das principais
            ['migration' => '2025_01_20_000000_create_vasilhame_movimentacoes_table', 'batch' => 6],
            ['migration' => '2025_01_21_000000_add_vasilhame_model_id_to_vasilhame_movimentacoes_table', 'batch' => 6],
        ...
        $pdo->commit();
        echo "\n✅ Migrações organizadas no banco de teste!\n";
