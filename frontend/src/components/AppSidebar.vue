    ...
    >
      ...
      <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div v-if="!isCollapsed" class="px-3 py-2">
          <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Financeiro</h3>
        </div>
        ...
        <router-link
          ...
          :title="isCollapsed ? 'Contas a Pagar' : ''"
        >
          <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
          </svg>
          <span v-if="!isCollapsed" class="ml-3">Contas a Pagar</span>
        </router-link>
