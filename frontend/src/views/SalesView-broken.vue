<template>
  <div class="min-h-screen bg-gray-100 flex flex-col">
          ...
          <div v-else class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3">
              <div
                ...
                :class="{ 
                  ...
                  'cursor-pointer hover:border-primary-300 hover:shadow-md': (product.actual_stock || product.stock_quantity) > 0,
                  'opacity-50 cursor-not-allowed bg-gray-50': (product.actual_stock || product.stock_quantity) <= 0
                }"
    ...
    <!-- Modal de Quantidade -->
    <div v-if="showQuantityModal && selectedProduct" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
...
const addToCartWithQuantity = () => {
  ...
  // Fechar modal e focar na busca
  showQuantityModal.value = false
  selectedProduct.value = null
  quantityInput.value = 1
  
  // Focar na busca para continuar adicionando produtos
  nextTick(() => {
